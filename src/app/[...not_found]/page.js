...
export default function NotFound() {
  ...
  <div className="bg-slate-950 border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
      ...
      <a href="#" className="flex items-center space-x-2 bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
